...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Calcular puntos no dominados en FUN.csv y sincronizarlos con VAR.csv."
    )
    parser.add_argument("--fun-file", help="Ruta al archivo FUN.csv")
    parser.add_argument("--var-file", help="Ruta al archivo VAR.csv")
    parser.add_argument(
        "--output-fun", help="Ruta para guardar el archivo de salida de FUN no dominado"
    )
    parser.add_argument(
        "--output-var", help="Ruta para guardar el archivo de salida de VAR no dominado"
    )
