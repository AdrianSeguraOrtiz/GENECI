...
df_combined = pd.merge(
    df_table1_sorted, df_table2, left_on="Algorithm", right_on="algorithm", how="left"
)
...
latex_table_combined = tabulate(
    df_combined, headers="keys", tablefmt="latex", showindex=False
)
