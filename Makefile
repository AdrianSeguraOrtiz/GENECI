...
build-simulator-images:
	@$(PYTHON) $(GENERATE_DEV_SCRIPTS)/build_simulator_images.py $(ARGS)

push-simulator-images:
	@$(PYTHON) $(GENERATE_DEV_SCRIPTS)/sync_simulator_images.py push $(ARGS)

pull-simulator-images:
	@$(PYTHON) $(GENERATE_DEV_SCRIPTS)/sync_simulator_images.py pull $(ARGS)

list-simulator-images:
	@$(PYTHON) $(GENERATE_DEV_SCRIPTS)/sync_simulator_images.py list $(ARGS)
...
validate-simulatorspecs:
	@$(PYTHON) $(GENERATE_DEV_SCRIPTS)/validate_simulatorspecs.py $(ARGS)

validate-simulator-smoketest-configs:
	@$(PYTHON) $(GENERATE_DEV_SCRIPTS)/validate_smoketest_configs.py $(ARGS)
...
scaffold-simulator:
	...
	@$(PYTHON) $(GENERATE_DEV_SCRIPTS)/scaffold_simulator.py --simulator $(SIMULATOR) --wrapper $(WRAPPER) $(ARGS)
...
prepare-simulator-papers:
	...
	@$(PYTHON) $(GENERATE_DEV_SCRIPTS)/prepare_simulator_papers.py --simulator $(SIMULATOR) $(ARGS)
...
verify-simulator:
	...
	@$(PYTHON) $(GENERATE_DEV_SCRIPTS)/validate_simulatorspecs.py --simulator $(SIMULATOR)
	@$(PYTHON) $(GENERATE_DEV_SCRIPTS)/validate_smoketest_configs.py --simulator $(SIMULATOR)
	@$(PYTHON) $(GENERATE_DEV_SCRIPTS)/build_simulator_images.py --simulator $(SIMULATOR)
	@$(PYTHON) $(GENERATE_DEV_SCRIPTS)/run_smoketests.py --simulator $(SIMULATOR) --skip-build $(ARGS)
