...
parser = argparse.ArgumentParser(
    description="This component is responsible for evaluating the accuracy with which networks belonging to the DREAM challenges are predicted."
)
parser.add_argument(
    "--challenge",
    type=str,
...
parser.add_argument(
    "--network-id", type=str, help="Predicted network identifier. Ex: 10_1"
)
parser.add_argument(
    "--synapse-folder",
    type=Path,
    help="Path to the folder containing the necessary synapse files",
)
parser.add_argument(
    "--confidence-list",
    type=Path,
...
folder = (
    "/root/.config/dreamtools/dream" + args.challenge[1] + "/" + args.challenge + "/"
)
