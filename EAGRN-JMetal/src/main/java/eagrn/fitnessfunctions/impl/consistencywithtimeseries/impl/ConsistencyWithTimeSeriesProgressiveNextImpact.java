...
public class ConsistencyWithTimeSeriesProgressiveNextImpact extends ConsistencyWithTimeSeries {
    
    public ConsistencyWithTimeSeriesProgressiveNextImpact(Map<String, Double[]> timeSeriesMap) {
        super(timeSeriesMap);
