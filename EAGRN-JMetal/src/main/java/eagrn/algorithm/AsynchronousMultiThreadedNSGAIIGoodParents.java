...
public class AsynchronousMultiThreadedNSGAIIGoodParents<S extends Solution<?>>
    extends AsynchronousMultiThreadedGeneticAlgorithmGoodParents<S> {

  public AsynchronousMultiThreadedNSGAIIGoodParents(
      int numberOfCores,
      Problem<S> problem,
      int populationSize,
