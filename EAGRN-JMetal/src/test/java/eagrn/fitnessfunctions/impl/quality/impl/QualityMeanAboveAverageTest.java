...
public class QualityMeanAboveAverageTest {
    ...
    void shouldReturnFitnessValueCaseA() {
        ...
        QualityMeanAboveAverage qualityMeanAboveAverage = new QualityMeanAboveAverage(inferredNetworks);
        ...
        double fitnessGoodWeights = qualityMeanAboveAverage.run(consensusOfGoodWeights, goodWeights);
        double fitnessBadWeights = qualityMeanAboveAverage.run(consensusOfBadWeights, badWeights);
