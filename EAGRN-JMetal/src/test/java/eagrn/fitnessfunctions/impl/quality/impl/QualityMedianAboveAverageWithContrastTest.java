...
public class QualityMedianAboveAverageWithContrastTest {
    ...
    void shouldReturnFitnessValueCaseA() {
        ...
        QualityMedianAboveAverageWithContrast qualityMedianAboveAverageWithContrast = new QualityMedianAboveAverageWithContrast(geneNames.size(), inferredNetworks);
        ...
        double fitnessGoodWeights = qualityMedianAboveAverageWithContrast.run(consensusOfGoodWeights, goodWeights);
        double fitnessBadWeights = qualityMedianAboveAverageWithContrast.run(consensusOfBadWeights, badWeights);
