...
public class QualityMedianTest {
    ...
    void shouldReturnFitnessValueCaseA() {
        ...
        QualityMedian qualityMedian = new QualityMedian(inferredNetworks);
        ...
        double fitnessGoodWeights = qualityMedian.run(consensusOfGoodWeights, goodWeights);
        double fitnessBadWeights = qualityMedian.run(consensusOfBadWeights, badWeights);
