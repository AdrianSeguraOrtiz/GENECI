...
do
    ...
    for i in {1..25}
    do
        python EAGRN-Inference.py optimize-ensemble $str --gene-names $network_folder/gene_names.txt --population-size 100 --num-evaluations 10000 --output-dir $network_folder/ea_consensus_$i
    done
done
